...
<head>
    ...
    <script type="text/javascript" src="//cdn.bootcss.com/angular.js/1.5.0-rc.2/angular.min.js"></script>
    ...
    <footer id="footer">
        <div class="container" ng-if="showURLinks">
            <div class="container-left" style="float: left;line-height: 35px;">
                <a href="http://hfiprogramming.club"><span class="provided">HFIProgramming</span></a><span><a href="https://lwl.moe/" target="_blank">本页面衍生自 lwl自由空间 旗下监控页</a> | </span><span class="hitokoto" id="hitokoto">Loading...</span>
            </div>
