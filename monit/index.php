    ...
    <footer id="footer">
        <div class="container" ng-if="showURLinks">
            <div class="container-left" style="float: left;line-height: 35px;">
                <span class="provided">liwanglin12's </span><span><a href="https://lwl.moe/" target="_blank">主页</a> |
                <a
                    href="http://blog.lwl12.com" target="_blank">博客</a> | <a href="https://img.lwl12.com" target="_blank">图床</a> | <a href="https://status.lwl12.com/" target="_blank">监控</a>                    | </span><span class="hitokoto" id="hitokoto">Loading...</span>
            </div>
