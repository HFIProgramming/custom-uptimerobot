    ...
    <footer id="footer">
        <div class="container" ng-if="showURLinks">
            <div class="container-left" style="float: left;line-height: 35px;">
                <a href="http://hfiprogramming.club"><span class="provided">HFIProgramming</span></a><span><a href="https://lwl.moe/" target="_blank">本页面衍生自 LWL的自由天空 旗下监控页</a> | </span><a href="https://github.com/HFIProgramming/custom-uptimebot"><span> 项目地址 | </span></a><span class="hitokoto" id="hitokoto">Loading...</span>
            </div>
